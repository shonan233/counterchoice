...
Though runtime performance is not a primary research objective, we found that different ways of phrasing the constraints within Dusa had dramatic impacts on the time to first solution, and importantly, the length of cantus firmus for which we could find a solution before running out of memory. (Indeed, the search space is exponential.)
