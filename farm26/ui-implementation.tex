...
With the goal in mind of supporting interactions with the Dusa counterpoint
generator grounded in the domain conventions of music, we developed a
web-based graphical user interface.  The following subsections describe our
design goals, a user's-eye view of the current prototype, and the software
