...
Erdem and Angiuli developed the Dusa implementation.
Prakash and McCann developed the web application.
Martens supervised the Dusa implementation.
Bohrer formulated research questions and summarized findings.
Cong contributed to the user study.
All the authors participated in the discussion and paper writing.
