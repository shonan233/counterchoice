...
An experimental extension is proposed in Section \ref{sec:divide-and-conquer} which uses dynamic programming to achieve polynomial complexity for longer pieces.
