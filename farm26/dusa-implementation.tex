...
An experimental extension is proposed in Section \ref{sec:dynamic-programming} which uses dynamic programming to achieve polynomial complexity for longer pieces.
