...
\subsection{Dusa Implementation}
\label{ssec:dusa-code}
...
These tools are written in JavaScript using the Dusa API, and generally append an input cantus firmus---represented as a list of \verb|cf T is N| and \verb|length is T| facts---to a Dusa program implementing the rules of counterpoint (e.g., as described in Section~\ref{ssec:dusa-code}).
