...
\CM{added this as a kind of transition between sections. It could also go
at the start of the next section, but it seems like this section should end
with at least a line or two of prose to put it all together.}
...
collection of ground \verb|cf| facts for consecutive time steps, such as:
...
Then Dusa produce solutions that contain, for example, the following
