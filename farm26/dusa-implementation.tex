...
\subsection{Extension: Dynamic-Programming Approach}
\label{sec:dynamic-programming}
In practice, the above algorithm can solve 30-note cantus firmi in 1--2 seconds, which sufficed for our needs.
In principle, a polynomial time algorithm is desirable for even longer pieces.
...
Nonetheless, the divide-and-conquer implementation provides valuable evidence that polynomial-time algorithms is feasible.
