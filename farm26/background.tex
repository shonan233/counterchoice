...
similar to answer set programming~\cite{lifschitz2019answer},
but more naturally supports the characterization of
...
the Dusa implementation.\footnote{\url{https://github.com/robsimmons/dusa}}
