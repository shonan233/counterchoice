...
Ari (update the screenshot; use the cantus firmus from the video and add some annotations)
...
Rose revised recommendations, moved divide and conquer back to the implementation section, and clarified why Javascript was used in divide and conquer.
...
Jim added a footnote in the introduction and expanded the list of examples in the related work.
The Ovans and Davison paper was hard to locate -- reviewer's link didn't work. Eventually found it by getting [the whole proceedings](https://www.caiac.ca/sites/default/files/shared/canai-archives/1992_CSCSI_Proceedings-opt.pdf).
...
Youyou added annotations to the bad example.
