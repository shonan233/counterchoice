...
\paragraph{RQ1: When we attempt to express the principles of counterpoint as ``executable knowledge'' in a logic programming language, how does the computational formalism compare with the musical formalism?}
...
In contrast, we preferred to write test code in a more imperative formalism than the implementation, because we are more confident that we interpreted musical formalisms correctly if the interpretations across two code formalisms agree.



\paragraph{RQ2: How easily and modularly can a mixed-initiative creative interface be developed for the Dusa solver that supports familiar affordances and notation for music composition without modifying the underlying language?}

\paragraph{RQ3: What does this case study reveal about the existing
